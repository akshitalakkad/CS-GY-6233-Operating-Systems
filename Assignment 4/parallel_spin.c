...
pthread_spinlock_t spinlock[NUM_BUCKETS];  //Globally declare spinlock
...
void insert(int key, int val) {
    ...
    /* Adding a lock to insertion of key-val pair in the hashtable
       This was ocnsiderably faster than a single mutex.
       But with the increase in the number of threads, the retreival time was larger than mutex.This could be because of the the busy waiting period due to repeated lock checking by spinlocks.
    */
